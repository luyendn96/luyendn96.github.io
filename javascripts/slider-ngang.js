$(function(){
	...
	var image_count = $('.slide-images1').length;
	var image_width = $('.slide-images1').width();
	...
	function left_slide_circle(){
		$('.slide-images1:last-child').addClass('swapthis'); // Xác định hình đang ở vị trí cuối cùng
		$('.swapthis').insertBefore('.slide-images1:first'); // Chuyển hình cuối lên trước hình đầu tiên
	...
	function right_slide_circle(){
		$('.slide-images1:first').addClass('swapthis'); // Xác định hình đang ở vị trí cuối cùng
		$('.swapthis').insertAfter('.slide-images1:last-child'); // Chuyển hình cuối lên trước hình đầu tiên
